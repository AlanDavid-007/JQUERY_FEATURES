...
<body>
    ...
    <div class="container d-flex justify-content-around mt-3">
        <button class="btn btn-primary button-fade1" value="1">Hello, world!</button>
        <button class="btn btn-primary button-fade2" value="1">Hello, world!</button>
        <button class="btn btn-primary button-fade3" value="1">Hello, world!</button>
    </div>
    <!-- <div class="container d-flex justify-content-center mt-3 card-mobile">
        <div class="card img1" style="width: 18rem;">
            <img class="card-img-top" src="https://cdn.pixabay.com/photo/2022/07/25/15/18/cat-7344042_960_720.jpg" alt="Card image cap">
        </div>
    </div>
